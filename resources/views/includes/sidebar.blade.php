...
<nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            <div class="d-flex justify-content-between align-items-center px-3 mt-3">
                ...
                <ul class="navbar-nav no-arrow">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle p-2 rounded" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-h text-secondary fa-fw"></i></a>
            ...
            @if ($menu['name'] == 'Search')
            <a class="nav-link py-2" href="javascript:void(0);" id="search-link" data-bs-toggle="modal" data-bs-target="#search-modal">
            ...
            <a class="nav-link py-2 
                    @if (request()->route()->getName() === $menu['route'] &&
                        $menu['route'] != 'test') active @endif" href="{{ route($menu['route']) }}" @if ($menu['name']=='Notifications' ) id="notification-menu" @endif>
                <div class="sb-nav-link-icon"><i class="{{ $menu['icon'] }}"></i></div>
                {{ $menu['name'] }}
    ...
    : '99+' }}
            ...
            <a class="nav-link py-2 mt-5 collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="true" aria-controls="collapseLayouts">
            ...
            <div class="collapse show" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav pt-1">
                    <a class="nav-link py-2" data-bs-toggle="modal" href="javascript:void(0);" data-bs-target="#exampleModal" data-whatever="@mdo">
