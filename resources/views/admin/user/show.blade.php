<div class="card card-shadow mt-3 p-3" id="space-{{ $post->id }}">
	<div class="card-body d-flex justify-content-between">
		<p>{{ $post->name }}</p>
		<p class="text-muted">{{ titleCase($post->name) }}</p>
		<div class="dropdown">
			...
			<ul class="dropdown-menu" aria-labelledby="edit-dropdown">
				<li>
					<a class="dropdown-item edit-spaces" href="javascript:void(0);" data-id="{{ $post->id }}">
