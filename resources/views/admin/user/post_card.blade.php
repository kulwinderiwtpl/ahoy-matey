    ...
    <div class="card-body p-3">
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
                <img src="{{ $userimage }}" class="icon_bgColor">
        ...
        <!-- <div class="d-flex">
            ...
            @endif
            <button class="btn btn-sm" data-bs-toggle="collapse" data-bs-target="#collapseExample-{{ $post->id }}" data-btn="btn-{{ $post->id }}">
        ...
        <div class="collapse" id="collapseExample-{{ $post->id }}">
            <div class="d-flex align-item-center justify-content-evenly">
                ...
                <i class="fas fa-thumbs-up reaction" data-id="{{ $post->id }}" data-reaction="fas fa-thumbs-up"></i>
                <i class="far fa-heart reaction" data-id="{{ $post->id }}" data-reaction="far fa-heart"></i>
                <i class="fas fa-thumbs-down reaction" data-id="{{ $post->id }}" data-reaction="fas fa-thumbs-down"></i>
            </div>
        </div>
    </div>
</div>