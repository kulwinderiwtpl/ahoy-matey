                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control @error('password') is-invalid @enderror" id="inputPassword" type="password" placeholder="Password" name="password" value="{{ old('password') }}" />
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                ...
                                <button type="submit" class="btn btn-primary px-5 py-2">{{ __('Login') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
