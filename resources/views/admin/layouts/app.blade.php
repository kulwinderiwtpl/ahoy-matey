...
<head>
    ...
    <title>{{ $pageTitle ?? config('app.name', 'Admin') }} | Dashboard 2</title>
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{ url('public/assets/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
        </div>
                ...
                <!--li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="{{ url('public/assets/dist/img/user1-128x128.jpg'
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{url('admin/')}}" class="brand-link">
                <img src="{{ url('public/assets/dist/img/AdminLTELogo.png') }}" alt="Ahoy Matey Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Ahoy Matey</span>
            </a>
            <div class="sidebar">
        ...
        <aside class="control-sidebar control-sidebar-dark">
			<ul class="dropdown-menuu dropdown-menu-end show">                            
				<li><a class="dropdown-item" href="{{ url('/admin/profile') }}">Account Settings</a></li>
        ...
        <footer class="main-footer">
            <strong><a href="{{ url('/') }}">View Site</a></strong>
